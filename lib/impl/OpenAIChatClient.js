...
class OpenAIChatClient extends _ChatClientBase.ChatClientBase {
  async initialize(apiKeyValues) {
    const openAiApiKey = (0, _serverChatHelpers.checkAndGetEnv)(
      apiKeyValues,
      _types.VALID_ENV_KEYS.OPENAI_API_KEY,
    )
    const openAiOrganizationId = (0, _serverChatHelpers.getEnv)(
      apiKeyValues,
      _types.VALID_ENV_KEYS.OPENAI_ORGANIZATION_ID,
    )
